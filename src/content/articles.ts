...
Не непременно лоша компания. Не непременно лоши хора.
...
И още няколко малки сигнала. Личният работен ритъм на мениджъра без автоматично очакване за същия ритъм от екипа. Късен имейл без задължение за късен отговор. Свобода в търсенето на информация и избора на подход. Въпросите като част от ориентацията, а не като повод за подозрение.

Дребни ситуации. Големи послания.

Доверие. Автономност. Подкрепа. Граници. Уважение към личното време.

Няколко дни между двете преживявания.

Същият човек. Същият професионален опит. Същите знания и способности.

Коренно различно усещане.

## Културата отвъд списъка с придобивки
...
В начина на посрещане на новия човек. В отношението към различното мнение. В реакцията при грешка. В разпределението на доверие и свобода. В границата между лична отговорност и контрол. В отношението към времето, индивидуалността и професионалната преценка.

И точно тук една важна разлика между корпоративните ценности и организационната култура.

От едната страна - думи за желаната идентичност.

От другата - ежедневното преживяване зад тях.
...
Недостатъчна адаптивност? Прекалено високи очаквания? Непоносимост към правила? Трудност с авторитети?

А може би нещо много по-просто.

Несъвпадение.

Между личните и организационните ценности. Между собственото разбиране за доверие и това на средата. Между необходимостта от автономност и културата на контрол. Между желанието за принадлежност и ясно очертаните граници на „ние“ и „вие“.

Една култура: постоянно усещане за чуждо място.

Друга - покана към общността.
